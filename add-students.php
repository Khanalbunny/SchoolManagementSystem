...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (move_uploaded_file($_FILES["image_path"]["tmp_name"], $target_file)) {
            ...
            $stmt->execute([$first_name, $middle_name, $last_name, $roll_number, $email, $gender, $class, $date_of_birth, $address, $phone, $target_file, $password, $confirm_password, $status]);
                ...
                <div class="col-md-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit="return validatePhoneNumber();">
