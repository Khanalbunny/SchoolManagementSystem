    ...
    <div class="alert alert-danger left-icon-alert" role="alert">
                                        ...
                                        <?php } ?>
                                            <div class="panel-body p-20">
                                                ...
                                                <tbody>
<?php $sql = "SELECT distinct student.StudentId,student.first_name,student.middle_name,student.last_name,student.roll_number,student.class,student.registered_date,student.Status,tblclasses.ClassName,tblclasses.Section,tblclasses.Section from tblresult join student on student.StudentId=tblresult.StudentId  join tblclasses on tblclasses.id=tblresult.ClassId";
