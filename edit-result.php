...
<body class="top-navbar-fixed">
    <div class="main-wrapper">
                            ...
                            <div class="col-md-12">
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <?php } ?>
                                        <form class="form-horizontal" method="post" onsubmit="return validateMarks();">

                                            <?php $ret = "SELECT student.first_name,student.middle_name,student.last_name,tblclasses.ClassName,tblclasses.Section from tblresult join student on tblresult.StudentId=tblresult.StudentId join tblsubjects on tblsubjects.id=tblresult.SubjectId join tblclasses on tblclasses.id=student.class where student.StudentId=:stid limit 1";
                                            ...
                                            <?php $sql = "SELECT distinct student.StudentId,student.first_name,student.middle_name,student.last_name,tblclasses.ClassName,tblclasses.Section,tblsubjects.SubjectName,tblresult.marks,tblresult.id as resultid from tblresult join student on student.StudentId=tblresult.StudentId join tblsubjects on tblsubjects.id=tblresult.SubjectId join tblclasses on tblclasses.id=student.class where student.StudentId=:stid ";
                                            $query = $dbh->prepare($sql);
        ...
        <!-- /.main-wrapper -->
        <script src="js/marksvalidation.js"></script>
