            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="student.php">Students</a></li>
                    </ul>
                </div>
            </div>
        </nav>
...
<?php }} ?>
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Student Result Management System <?php echo date('Y');?></p></div>
        </footer>
        <!-- Bootstrap core JS-->
